...
public extension Date {
    ...
    func toString(style: DateStyleType = .short) -> String {
        ...
        case .shortBip:
            return self.toString(format: DateFormatType.custom("dd.MM.yyyy"))
        }
    }
...
public enum DateFormatType {
    ...
    /// The ISO8601 formatted date "dd/MM/yyyy" i.e. 16/07/1996
    case isoDateBars
    /// The ISO8601 formatted date and time "yyyy-MM-dd'T'HH:mmZ" i.e. 1997-07-16T19:20+01:00
    case isoDateTime                                                          
    /// The ISO8601 formatted date, time and sec "yyyy-MM-dd'T'HH:mm:ssZ" i.e. 1997-07-16T19:20:30+01:00
    case isoDateTimeSec                                                        
    /// The ISO8601 formatted date, time and sec "yyyy-MM-dd'T'HH:mm:ssZ" i.e. 1997-07-16T19:20:30
    case isoDateTimeSecBIP
    ...
    var stringFormat:String {
        ...
        case .isoDateBars: return "dd/MM/yyyy"
        case .isoDateTime: return "yyyy-MM-dd'T'HH:mmZ"
        case .isoDateTimeSecBIP: return "yyyy-MM-dd'T'HH:mm:ss"
